...
public class StoreController {
	...
	public String orderSearch(HttpSession session, HttpServletRequest request, Model model, PageDTO pageDTO)
			throws Exception {
...
//		}
		...
		if (item_name == "" && item_sminPrice == null && item_smaxPrice == null && od_minTime == "" && od_maxTime == ""
				&& received_not == 100) {
	...
	public String receiveSearch(HttpSession session, HttpServletRequest request, Model model, PageDTO pageDTO)
			throws Exception {
		...
		if (item_name == "" && item_sminPrice == "" && item_smaxPrice == "" && rc_minTime == "" && rc_maxTime == ""
				&& pay == 100) {
	...
	public String resultSearch(HttpSession session, HttpServletRequest request, Model model, PageDTO pageDTO)
			throws Exception {
	...
	public String consumeSearch(HttpSession session, HttpServletRequest request, Model model, PageDTO pageDTO)
			throws Exception {
...
//		}
	...
	public String sellSearch(HttpSession session, HttpServletRequest request, Model model, PageDTO pageDTO)
			throws Exception {
	...
	// storeService.stockCheck(stockDTO.getStock_num());
	//
	//// String result ="";
	...
	//// result = "재고가 있습니다.";
	//// }
	// ResponseEntity<List<StockDTO>> entity = new
	// ResponseEntity<List<StockDTO>>(stockDTOList, HttpStatus.OK);
	// return entity;
	// }
